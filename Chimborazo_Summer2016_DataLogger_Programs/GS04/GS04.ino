...
////////////////////////////
char* dataLoggerName = "Glacier Station 4";
char* fileName = "GS04.txt";
...
// Temperature probe = T2 (from calibration sheet)
// Voltages measured with Fluke meter, not checked against precision Vref

logger.HM1500LF_humidity_with_external_temperature(1, 3.285, 10080.4120953, 3298.34232031, 10000, 25, 0);
logger.Inclinometer_SCA100T_D02_analog_Tcorr(6, 2, 3.285, 5.191, 10080.4120953, 3298.34232031, 10000, 25, 0);
