...
////////////////////////////
char* dataLoggerName = "Glacier Station 3";
char* fileName = "GS03.txt";
...
logger.HM1500LF_humidity_with_external_temperature(1, 3.303, 10042.8622609, 3294.91946799, 10000, 25, 0);
logger.Inclinometer_SCA100T_D02_analog_Tcorr(6, 7, 5.186, 10042.8622609, 3294.91946799, 10000, 25, 0);
