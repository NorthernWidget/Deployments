...
////////////////////////////
char* dataLoggerName = "Glacier Station 1";
char* fileName = "GS01.txt";
...
// Temperature probe = T5 (from calibration sheet)
// Voltages measured with Fluke meter, not checked against precision Vref

logger.HM1500LF_humidity_with_external_temperature(1, 3.279, 10043.0560595, 3294.71324119, 10000, 25, 0);
logger.Inclinometer_SCA100T_D02_analog_Tcorr(6, 7, 5.170, 10043.0560595, 3294.71324119, 10000, 25, 0);
