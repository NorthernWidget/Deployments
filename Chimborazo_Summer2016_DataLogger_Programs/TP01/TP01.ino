...
logger.thermistorB(10158.848984, 3804.8572434, 10000, 25, 0); //  0  cm
logger.thermistorB(1, 1, 10000, 25, 1); // -5  cm; nonfunctional -- REPLACE!
logger.thermistorB(10124.5053815, 3827.26674903, 10000, 25, 2); // -10 cm
logger.thermistorB(10029.9211168, 3829.60196705, 10000, 25, 3); // -15 cm
logger.thermistorB(10138.4667861, 3812.79022123, 10000, 25, 6); // -25 cm
logger.thermistorB(10134.7221787, 3828.75074905, 10000, 25, 7); // -35 cm
