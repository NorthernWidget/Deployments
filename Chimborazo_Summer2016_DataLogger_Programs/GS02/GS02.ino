...
////////////////////////////
char* dataLoggerName = "Glacier Station 2";
char* fileName = "GS02.txt";
...
logger.HM1500LF_humidity_with_external_temperature(1, 3.279, 9954.43447576, 3293.68525082, 10000, 25, 0);
logger.Inclinometer_SCA100T_D02_analog_Tcorr(6, 7, 5.173, 9954.43447576, 3293.68525082, 10000, 25, 0);
