...
////////////////////////////
char* dataLoggerName = "Glacier Station 6";
char* fileName = "GS06.txt";
...
// Temperature probe = T4 (from calibration sheet)
// Voltages measured with Fluke meter, not checked against precision Vref

logger.HM1500LF_humidity_with_external_temperature(1, 3.283, 10059.858708, 3294.71324119, 10000, 25, 0);
logger.Inclinometer_SCA100T_D02_analog_Tcorr(6, 7, 3.283, 5.191, 10059.858708, 3294.71324119, 10000, 25, 0);
